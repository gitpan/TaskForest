...
for (my $n = 1; $n <= $num_tries; $n++) { 
    sleep $SLEEP_TIME;
    last if (-e "$log_dir/DEBUG.J2.0" and
             -e "$log_dir/DEBUG.J3.0" and
             -e "$log_dir/DEBUG.J6.0" and
             -e "$log_dir/DEBUG.J7.0" and
             -e "$log_dir/DEBUG.J9.0" );
...
ok(-e "$log_dir/DEBUG.J2.0", "  After first cycle, J2 ran successfully") || diag ($diag) ;
ok(-e "$log_dir/DEBUG.J3.0", "  After first cycle, J3 ran successfully") || diag ($diag) ;
ok(-e "$log_dir/DEBUG.J6.0", "  After first cycle, J6 ran successfully") || diag ($diag) ;
ok(-e "$log_dir/DEBUG.J7.0", "  After first cycle, J7 ran successfully") || diag ($diag) ;
ok(-e "$log_dir/DEBUG.J9.0", "  After first cycle, J9 ran successfully") || diag ($diag) ;
